const Header = () => {
  return (
    <div className="header">
      <img
        className="headerimg"
        src="https://content.api.news/v3/images/bin/5024cceaa04695dde11f00378e65d3d9?width=768"
        alt="2022 Premiership"
      />
      ...
      <p className="history">
        ...
        an elite level of any code in the world. <br /> <br />
        ...
        elbows produced bone shattering results. <br /> <br /> Geelong has a
        proud history, having won ten AFL and seven VFA premierships in its
        history. The Cats tasted success in 1925, 1931, 1937, 1951, 1952, 1963,
        2007, 2009, 2011 and 2022. The club has also won flags at other levels,
        including the night cup, reserves, under 19 and VFA/VFL. <br /> <br />{' '}
        Below are the players of the 2024 squad.
      </p>
    </div>
  )
}
